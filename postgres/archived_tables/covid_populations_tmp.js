const createQuery = `-- Table: public.covid_populations_tmp

-- DROP TABLE IF EXISTS public.covid_populations_tmp;

CREATE TABLE IF NOT EXISTS public.covid_populations_tmp
(
...
ALTER TABLE IF EXISTS public.covid_populations_tmp
    OWNER to postgres;`;
