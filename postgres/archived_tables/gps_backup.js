const createQuery = `-- Table: public.gps_backup

-- DROP TABLE IF EXISTS public.gps_backup;

CREATE TABLE IF NOT EXISTS public.gps_backup
(
    ...
    commissioner character varying(255) COLLATE pg_catalog."default",
    join_provider_purchaser_date character varying(255) COLLATE pg_catalog."default",
    left_provider_purchaser_date character varying(255) COLLATE pg_catalog."default",
    ...
    provider_purchaser character varying(255) COLLATE pg_catalog."default",
    null_8 character varying(255) COLLATE pg_catalog."default",
    prescribing_setting character varying(255) COLLATE pg_catalog."default",
    null_10 character varying(255) COLLATE pg_catalog."default",
...
ALTER TABLE IF EXISTS public.gps_backup
    OWNER to postgres;`;
