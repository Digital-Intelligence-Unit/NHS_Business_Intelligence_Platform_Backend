const createQuery = `-- Table: public.virtual_ward_decision

-- DROP TABLE IF EXISTS public.virtual_ward_decision;

CREATE TABLE IF NOT EXISTS public.virtual_ward_decision
(
    id double precision,
...
ALTER TABLE IF EXISTS public.virtual_ward_decision
    OWNER to postgres;
-- Index: virtual_ward_index

-- DROP INDEX IF EXISTS public.virtual_ward_index;

CREATE INDEX IF NOT EXISTS virtual_ward_index
    ON public.virtual_ward_decision USING btree
    (loaded_date COLLATE pg_catalog."default" DESC NULLS FIRST)
    TABLESPACE pg_default;

ALTER TABLE IF EXISTS public.virtual_ward_decision
    CLUSTER ON virtual_ward_index;`;
