const createQuery = `-- Table: public.virtual_ward_decision_20201129

-- DROP TABLE IF EXISTS public.virtual_ward_decision_20201129;

CREATE TABLE IF NOT EXISTS public.virtual_ward_decision_20201129
(
    id double precision,
...
ALTER TABLE IF EXISTS public.virtual_ward_decision_20201129
    OWNER to postgres;`;
