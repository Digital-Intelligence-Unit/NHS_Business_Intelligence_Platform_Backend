const createQuery = `-- Table: public.covid19_cases_p1p2

-- DROP TABLE IF EXISTS public.covid19_cases_p1p2;

CREATE TABLE IF NOT EXISTS public.covid19_cases_p1p2
(
...
ALTER TABLE IF EXISTS public.covid19_cases_p1p2
    OWNER to postgres;`;
