const createQuery = `-- Table: public.population_history

-- DROP TABLE IF EXISTS public.population_history;
...
(
    ...
    rs_frailty_index double precision,
...
ALTER TABLE IF EXISTS public.population_history
    OWNER to postgres;`;
