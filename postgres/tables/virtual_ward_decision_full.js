const createQuery = `-- Table: public.virtual_ward_decision_full

-- DROP TABLE IF EXISTS public.virtual_ward_decision_full;

CREATE TABLE IF NOT EXISTS public.virtual_ward_decision_full
(
    id double precision,
...
ALTER TABLE IF EXISTS public.virtual_ward_decision_full
    OWNER to postgres;`;
