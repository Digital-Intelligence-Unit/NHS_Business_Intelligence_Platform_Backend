const createQuery = `-- Table: public.virtual_ward_history

-- DROP TABLE IF EXISTS public.virtual_ward_history;

CREATE TABLE IF NOT EXISTS public.virtual_ward_history
(
    id double precision,
    ...
    newcontact character varying COLLATE pg_catalog."default",
    nonreferral_reason character varying COLLATE pg_catalog."default",
...
ALTER TABLE IF EXISTS public.virtual_ward_history
    OWNER to postgres;`;
