const createQuery = `-- Table: public.temp_population_list

-- DROP TABLE IF EXISTS public.temp_population_list;

CREATE TABLE IF NOT EXISTS public.temp_population_list
(
...
ALTER TABLE IF EXISTS public.temp_population_list
    OWNER to postgres;`;
