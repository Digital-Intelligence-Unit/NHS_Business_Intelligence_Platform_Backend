const createQuery = `-- Table: public.trusts

-- DROP TABLE IF EXISTS public.trusts;
...
(
    ...
    gor_code character varying(255) COLLATE pg_catalog."default",
    null_8 character varying(255) COLLATE pg_catalog."default",
    null_9 character varying(255) COLLATE pg_catalog."default",
...
ALTER TABLE IF EXISTS public.trusts
    OWNER to postgres;`;
